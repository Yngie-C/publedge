...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "회원가입 후 스튜디오에서 '새 콘텐츠 만들기'를 통해 텍스트를 입력하거나 파일(TXT, MD, DOCX)을 업로드할 수 있습니다. 입력한 텍스트는 자동으로 전자책 형태로 변환되며, 오디오북도 생성할 수 있습니다.",
  },
  {
    question: "오디오북의 음성 품질은 어떤가요?",
    answer:
      "최신 음성 합성 기술을 활용하여 자연스러운 음성을 제공합니다. 현재 다양한 음성 옵션을 지원하며, 지속적으로 품질을 개선하고 있습니다.",
  },
];
