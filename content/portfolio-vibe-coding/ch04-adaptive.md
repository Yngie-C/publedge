  ...
  <section class="projects">
    ...
    <div class="project-grid">
      <article class="project-card">
        <h3 class="project-card__title">데이터 시각화 대시보드</h3>
        <p class="project-card__desc">공공데이터로 지역별 트렌드를 보여주는 인터랙티브 차트 프로젝트예요.</p>
        <a class="project-card__link" href="#" target="_blank">자세히 보기 →</a>
      </article>
      <article class="project-card">
        <h3 class="project-card__title">감정 분석 API</h3>
        <p class="project-card__desc">리뷰 텍스트에서 긍/부정을 분류하는 Flask 배포 프로젝트예요.</p>
        <a class="project-card__link" href="#" target="_blank">자세히 보기 →</a>
      </article>
      <article class="project-card">
        <h3 class="project-card__title">개인 독서 기록 앱</h3>
        <p class="project-card__desc">읽은 책을 기록하고 월별 통계를 보여주는 웹 앱이에요.</p>
        <a class="project-card__link" href="#" target="_blank">자세히 보기 →</a>
      </article>
    </div>
  </section>
